...
class group_workoutController {
  ...
  static async Get_All_booked_data_exercise(req, res) {
    var result = await group_workoutModel.Get_All_booked_data_exercise();
    if (result) {
      res.send(result);
    } else {
      res.send({
  ...
  static async getAllWorkout(req, res) {
    var result = await group_workoutModel.getAllWorkout();
    if (result) {
      res.send(result);
    } else {
      res.send({
